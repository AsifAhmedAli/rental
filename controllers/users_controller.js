      ...
      request(options, function (error, response) {
        ...
        contact_data_from_freshworks43.data.selected_additional_charges.forEach(
          (element) => {
            ...
            } else if (element.label == "Tablet - Unlimited Internet Data") {
              // console.log(element.label);
        ...
        url = `https://rentsmartrac.myfreshworks.com/crm/sales/api/contacts/upsert`;
        ...
        requestData = {
          unique_identifier: { emails: user_data_from_hqrentals.contact.email },
          contact: {
            ...
            custom_field: {
              ...
              cf_departure_flight_number: req.body.data.flight_departure_number,
