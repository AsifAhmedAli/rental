...
const test = (req, res) => {
  ...
  //   0|-a  |     reservation: {
  //   0|-a  |       id: null,
  //   0|-a  |       header: 'New Reservation',
  //   0|-a  |       pick_up_date: '2023-12-07 03:00:00',
  //   0|-a  |       return_date: '2023-12-08 08:00:00',
  //   0|-a  |       flight_arrival_date: '2023-12-07 03:00:00',
  //   0|-a  |       flight_departure_date: '2023-12-08 08:00:00',
  //   0|-a  |       flight_number: '',
  //   0|-a  |       flight_departure_number: '',
  //   0|-a  |       pick_up_location: [Object],
  //   0|-a  |       return_location: [Object],
  //   0|-a  |       vehicle_class_id: '20',
  //   0|-a  |       customer_id: null,
  //   0|-a  |       public_link: '',
  //   0|-a  |       comments: [],
  //   0|-a  |       distance_limits: [Object]
  //   0|-a  |     },
  //   0|-a  |     selected_vehicle_class: {
  //   0|-a  |       vehicle_class_id: 20,
  //   0|-a  |       sipp_code: null,
  //   0|-a  |       price: [Object],
  //   0|-a  |       vehicle_class: [Object],
  //   0|-a  |       distance_limits: [Object],
  //   0|-a  |       crx_requires_pre_payment: false
  //   0|-a  |     },
  //   0|-a  |     tour_operator: [],
  //   0|-a  |     additional_charges: [
  //   0|-a  |       [Object], [Object],
  //   0|-a  |       [Object], [Object],
  //   0|-a  |       [Object], [Object],
  //   0|-a  |       [Object], [Object],
  ...
  //   0|-a  |     ],
  //   0|-a  |     discounts: {
  //   0|-a  |       '2010': 'Discount 10%',
  //   0|-a  |       '2011': 'Discount 15%',
  //   0|-a  |       '20OFF': '20% Discount'
  //   0|-a  |     },
  //   0|-a  |     applicable_discounts: [ [Object] ],
  //   0|-a  |     applicable_taxes: [ [Object] ]
  //   0|-a  |   }
  //   0|-a  | }
  //   0|-a  | 2023-12-07T08:00:00.000000Z
  //   0|-a  | data updated
  //   0|-a  | 2023-12-07T08:00:00.000000Z
  //   0|-a  | {
  //   0|-a  |   success: true,
